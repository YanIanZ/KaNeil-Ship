...
type DockerNetworkConfiguration struct {
	...
	// defined.
	Name       string                  `default:"kaneil_nw"`
	ISPN       bool                    `default:"false" yaml:"ispn"`
	IPv6       bool                    `default:"true" yaml:"IPv6"`
	Driver     string                  `default:"bridge"`
	Mode       string                  `default:"kaneil_nw" yaml:"network_mode"`
...
type DockerConfiguration struct {
	...
	// if the value is "host", then the kaneil containers are started with user namespace
	// remapping disabled
	...
	LogConfig struct {
		...
		Config map[string]string `default:"{\"max-size\":\"10m\",\"max-file\":\"3\",\"compress\":\"false\",\"mode\":\"non-blocking\"}" json:"config" yaml:"config"`
